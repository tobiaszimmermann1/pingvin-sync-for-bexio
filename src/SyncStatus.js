...
const STATUS_LABEL = {
  idle: __("Abgeschlossen", "pingvin-sync-for-bexio"),
  running: __("Läuft", "pingvin-sync-for-bexio"),
  error: __("Fehler", "pingvin-sync-for-bexio")
}
      ...
      <Box p="5px 20px" color="pingvin.fontPrimary" mt="-1" bg="pingvin.white" borderColor="pingvin.border" borderWidth="1px" borderBottomRadius="md">
        {!state ? (
          <Text fontSize="sm" fontStyle="italic">
            {__("Keine Daten", "pingvin-sync-for-bexio")}
          </Text>
        ) : (
          <Table size="sm">
            <Tbody>
              <Tr>
                <Td border="0" pl="0">
                  <Text fontSize="sm" my="0">
                    {__("Status:", "pingvin-sync-for-bexio")}
                  </Text>
                </Td>
                <Td border="0">
              ...
              <Tr>
                <Td border="0" pl="0">
                  <Text fontSize="sm" my="0">
                    {__("Abgeschlossen:", "pingvin-sync-for-bexio")}
                  </Text>
                </Td>
                <Td border="0">
                  <Text fontSize="sm" my="0">
              ...
              <Tr>
                <Td border="0" pl="0">
                  <Text fontSize="sm" my="0">
                    {__("Aktualisiert:", "pingvin-sync-for-bexio")}
                  </Text>
                </Td>
                <Td border="0">
                  <Text fontSize="sm" my="0">
              ...
              <Tr>
                <Td border="0" pl="0">
                  <Text fontSize="sm" my="0">
                    {__("Übersprungen:", "pingvin-sync-for-bexio")}
                  </Text>
                </Td>
                <Td border="0">
                  <Text fontSize="sm" my="0">
              ...
              <Tr>
                <Td border="0" pl="0">
                  <Text fontSize="sm" my="0">
                    {__("Fehler:", "pingvin-sync-for-bexio")}
                  </Text>
                </Td>
                <Td border="0">
              ...
              {state.last_error && (
                <Tr>
                  <Td border="0" pl="0">
                    <Text fontSize="sm" my="0">
                      {__("Meldung:", "pingvin-sync-for-bexio")}
                    </Text>
                  </Td>
                  <Td border="0">
      ...
      <Stack direction="column" width="100%">
        ...
        {loading ? (
          ...
          <Stack direction="row" gap="10" flexWrap="wrap">
            <StateBox title={__("Produkte — Letzte Synchronisierung", "pingvin-sync-for-bexio")} state={productState} />
            <StateBox title={__("Kontakte — Letzte Synchronisierung", "pingvin-sync-for-bexio")} state={contactState} />
          </Stack>
        )}
      </Stack>
    </Flex>
