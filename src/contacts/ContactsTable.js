...
import { Table, Thead, Tbody, Tr, Th, Td, TableContainer, Flex, Button, Spinner, Stack, Text } from "@chakra-ui/react"
                          ...
                          <Stack>
                            <Flex flexDirection="row" alignItems="flex-start" gap="1" justifyContent="flex-start">
                              ...
                              <Text fontSize="sm" mt="0" mb="0" fontStyle="italic">
                                {__("Zuletzt synchronisiert am", "pingvin-sync-for-bexio")} {user.pvbexio_sync && user.pvbexio_sync.last_sync ? new Date(user.pvbexio_sync.last_sync).toLocaleString() : __("Unbekannt", "pingvin-sync-for-bexio")}
                              </Text>
                            </Flex>
                          </Stack>
                        ) : (
