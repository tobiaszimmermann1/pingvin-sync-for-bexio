...
import { Flex, Button, Spinner, Text, Radio, RadioGroup, Stack, Box, Select, TabPanel, Grid, GridItem, Table, Thead, Tbody, Tfoot, Tr, Th, Td, TableCaption, TableContainer } from "@chakra-ui/react"
            ...
            <Box fontFamily="mono" fontSize="xs" bg="gray.50" borderColor="pingvin.border" borderWidth="1px" borderRadius="md" p="3" maxH="400px" overflowY="auto">
              ...
              {logLines.map((line, i) => (
                <Flex key={i} gap="2" borderBottom="1px solid" borderColor="gray.100" py="0" my="1" alignItems="baseline">
                  ...
                  <Text flexShrink={0} minW="60px" fontWeight="bold" color={line.level_name === "ERROR" || line.level_name === "CRITICAL" ? "red.500" : line.level_name === "WARNING" ? "orange.500" : line.level_name === "DEBUG" ? "gray.400" : "blue.500"} my="1">
                    {line.level_name}
                  </Text>
