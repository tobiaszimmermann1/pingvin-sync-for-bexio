...
Tags: Buchhaltung, Schweiz, Synchronisierung, comptabilité, Suisse, synchronisation, contabilità, Svizzera, sincronizzazione, accounting, Switzerland, synchronization
...
_The use of Bexio and the Bexio API is subject to Bexios terms of service and privacy policy. More information can be found here: https://www.bexio.com/en-CH/policies_
...
After connection to Bexio and before starting the synchronisation process, you have to load the Bexio reference data (vat and unser data) on the settings page. If you have not done so yet, you should see a notice.
